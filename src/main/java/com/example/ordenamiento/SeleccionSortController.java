...
public class SeleccionSortController {
    ...
    private Seleccion seleccionSort;
    ...
    public SeleccionSortController() {
    ...
    public void initialize() {
        ...
        this.seleccionSort = new Seleccion();
    ...
    @FXML
    public void startSeleccionSort (ActionEvent actionEvent) {
        ...
        // Llamar al método combSort de la instancia de SeleccionSort
        double tiempo = seleccionSort.seleccionSort(size, limit);
