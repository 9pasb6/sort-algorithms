...
public class CombSortController {
    ...
    @FXML
    public void startCombSort(ActionEvent actionEvent) {
        ...
        // Llamar al método combSort de la instancia de CombSort
        double tiempo = combSort.combSort(size, limit);
